                                    ...
                                    <table id="task_new_table" class="table table-bordered half-trans-green">
                                        ...
                                        <tbody>
                                            ...
                                            <tr >
                                                ...
                                                <td>
                                                    <div class="col-xs-9 col-md-9 col-sm-9">
                                                        <select id="task_new_loadconf_select" class="form-control">
                                            ...
                                            <tr >
                                                <td colspan="2">
                                                    <a id="task_new_save_btn" href="javascript:saveNewTask(3);" class="btn btn-primary">保存</a>
