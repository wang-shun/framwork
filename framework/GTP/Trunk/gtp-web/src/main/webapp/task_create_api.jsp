                        ...
                        <div id="task_new_table_div" class="container-fluid">
                            <div class="row-fluid">
                                <div class="col-xs-6 col-xs-offset-3 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                                    ...
                                    <table id="task_new_table" class="table half-trans-green">
                                        <thead>
                                            <tr></tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-xs-9 col-md-9 col-sm-9">
                                                        <input class="form-control" type="text" id="task_new_name" name="task_new_name"/>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-xs-9 col-md-9 col-sm-9">
                                                        <input type="text" class="form-control" id="task_new_cq" placeholder="筛选条件表达式" name="task_new_cq"/>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-xs-5 col-md-5 col-sm-5">
                                                        <input type="checkBox" class="form-inline" id="task_new_isMachine" name="task_new_isMachine"/>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-xs-9 col-md-9 col-sm-9">
                                                        <input type="checkBox" class="form-inline" checked="checked" id="task_new_isMonited" name="task_new_isMonited"/>
                                                        <span class="form-inline">是否监控 ?&nbsp;&nbsp;</span>
                                                        <input type="checkBox" class="form-inline" id="task_new_isSplit" name="task_new_isSplit"/>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-xs-5 col-md-5 col-sm-5">
                                                        <input type="text" class="form-control" id="task_new_editor" name="task_new_editor" value="${sessionScope.userName}" readonly="true"/>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-xs-9 col-md-9 col-sm-9">
                                                        <textarea class="form-control" id="task_new_email" name="task_new_email" style="width:100%; height:80px;" placeholder="请填写收件人列表，以英文逗号分隔">${sessionScope.email}</textarea>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <a id="task_new_save_btn" href="javascript:saveNewTask(1);" class="btn btn-primary">保存</a>
                                                    <a id="task_new_cancel_btn" class="btn btn-default" onclick="window.history.back(-1)">取消</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
