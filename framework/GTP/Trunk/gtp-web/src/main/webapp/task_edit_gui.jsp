...
<head>
    ...
    <title>编辑GUI任务 ${taskInfo[0]}</title>
                    ...
                    <div class="row-fluid">
                        <div class="col-xs-6 col-xs-offset-3 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                            <div class="half-color-header">
                                <h2>编辑GUI任务 <span id="task_edit_id_span">${taskInfo[0]}</span></h2>
                            </div>
                            <table id="task_edit_table" class="table half-trans-green">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-xs-9 col-md-9 col-sm-9">
                                            <input type="text" class="form-control" id="task_edit_cq" name="task_edit_cq" value="${taskInfo[13]}"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-xs-5 col-md-5 col-sm-5">
                                            <%--<select id="task_edit_browser_select" class="form-control">--%>
                                                <c:forEach var="browser" items="${browsers}" varStatus="status">
                                                        <c:choose>
                                                            <c:when test="${fn:contains(selectedBrowsers, browser)}">
                                                                <input name="task_edit_browser" class="form-inline" type="checkbox" value="${browser}" checked="checked"/>
                                                                <span class="form-inline">${browser}</span><br>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <input name="task_edit_browser" class="form-inline" type="checkbox" value="${browser}"/>
                                                                <span class="form-inline">${browser}</span><br>
                                                            </c:otherwise>
                                                        </c:choose>
                                                </c:forEach>
                                                ...
                                                <c:forEach var="machine" items="${machines}">
                                                    <c:choose>
                                                        <c:when test="${machine[0] == taskInfo[4]}">
                                                            <option value="${machine[0]}" selected="selected" title="${machine[1]}"> ${machine[0]} </option>
                                                        </c:when>
                                                        <c:otherwise>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div>
                                            <a id="task_edit_save_btn" href="javascript:updateTaskInfo(2);" class="btn btn-primary">保存</a>
                                ...
                                <%--<tr>--%>
                                    ...
                                    <%--<a id="send" class="btn">发送</a>--%>
                                    <%--<script type="application/javascript">--%>

                                        <%--$('#send').on('click',function() {--%>
                                            <%--var taskId = $('#taskId').val();--%>
                                            <%--$.ajax({--%>
                                                <%--url:'/task/browserlist/' + taskId,--%>
                                                <%--type:'GET',--%>
